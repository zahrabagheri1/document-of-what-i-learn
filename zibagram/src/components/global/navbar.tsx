  ...
  return (
    <header className="relative bg-white p-3 shadow-md w-full flex justify-between">
      ...
      <div className={auth.isAuthenticated()? "flex flex-row": "hidden"}>
        ...
        <button
          onClick={onLogout}
          className=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-none font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 flex flex-row gap-2 items-center justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
